...
PanchangResponseData panchangResponseDataFromJson(String str) =>
    PanchangResponseData.fromJson(json.decode(str));

String panchangResponseDataToJson(PanchangResponseData data) =>
    json.encode(data.toJson());

class PanchangResponseData {
  ...
  factory PanchangResponseData.fromJson(Map<String, dynamic> json) =>
      PanchangResponseData(
